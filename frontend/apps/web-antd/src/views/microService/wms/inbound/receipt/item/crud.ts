...
import createLocationCrudOptions from '#/views/microService/wms/basic/location/crud';
import createMaterialCrudOptions from '#/views/microService/wms/metadata/material/crud';
