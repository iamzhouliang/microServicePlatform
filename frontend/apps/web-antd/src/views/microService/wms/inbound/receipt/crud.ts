...
import ReceiptItem from '#/views/microService/wms/inbound/receipt/item/index.vue';
import { supplierTable, warehouseTable } from '#/views/microService/wms/table-select';
