...
import aisleCrudOptionsTenant from '#/views/microService/wms/basic/aisle/crud';
import containerCrudOptionsTenant from '#/views/microService/wms/basic/container/crud';
import dockCrudOptionsTenant from '#/views/microService/wms/basic/dock/crud';
import locationCrudOptionsTenant from '#/views/microService/wms/basic/location/crud';
import locationSpecCrudOptionsTenant from '#/views/microService/wms/basic/location/spec/crud';
import storageAreaCrudOptionsTenant from '#/views/microService/wms/basic/storage-area/crud';
import warehouseCrudOptionsTenant from '#/views/microService/wms/basic/warehouse/crud';
import brandCrudOptionsTenant from '#/views/microService/wms/metadata/brand/crud';
import carrierCrudOptionsTenant from '#/views/microService/wms/metadata/carrier/crud';
import materialCrudOptions from '#/views/microService/wms/metadata/material/crud';
import supplierCrudOptionsTenant from '#/views/microService/wms/metadata/supplier/crud';
