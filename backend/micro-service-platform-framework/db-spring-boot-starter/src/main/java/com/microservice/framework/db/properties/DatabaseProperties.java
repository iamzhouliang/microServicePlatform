...
package com.microservice.framework.db.properties;
...
public class DatabaseProperties {
    ...
    public static class DataPermission {
         ...
         * </p>
         */
        private com.microservice.framework.db.mybatisplus.datascope.core.DataScopeConstants.Mode mode = 
                com.microservice.framework.db.mybatisplus.datascope.core.DataScopeConstants.Mode.SEPARATE_DATABASE;
    ...
    public static class MultiTenant {
         ...
         * 租户数据库前缀
         */
        private String dsPrefix = "micro-service_tenant_";
