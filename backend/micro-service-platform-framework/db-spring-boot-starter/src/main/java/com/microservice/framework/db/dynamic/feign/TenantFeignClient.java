...
package com.microservice.framework.db.dynamic.feign;
 ...
 * @author Levin
 */
@FeignClient(name = "micro-service-platform-iam", dismiss404 = true, fallback = TenantFeignClient.TenantFeignClientFallback.class)
