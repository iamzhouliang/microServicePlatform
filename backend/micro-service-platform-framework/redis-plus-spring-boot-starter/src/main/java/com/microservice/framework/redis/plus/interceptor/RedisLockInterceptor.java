...
package com.microservice.framework.redis.plus.interceptor;

import cn.hutool.core.util.StrUtil;
import com.microservice.framework.commons.exception.CheckedException;
import com.microservice.framework.redis.plus.RedisKeyGenerator;
import com.microservice.framework.redis.plus.anontation.RedisLock;
import com.microservice.framework.redis.plus.exception.RedisLockException;
...
public class RedisLockInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(com.microservice.framework.redis.plus.anontation.RedisLock)")
