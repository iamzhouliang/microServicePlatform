...
package com.microservice.framework.redis.plus.cache;
...
import com.microservice.framework.redis.plus.RedisPlusProperties;
...
public class RedisCacheAutoConfiguration implements CachingConfigurer {
    ...
    public KeyGenerator keyGenerator() {
        return (target, method, params) -> {
            ...
            final String jsonText = JacksonUtils.toJson(keyMap);
            // 使用MD5生成位移key
