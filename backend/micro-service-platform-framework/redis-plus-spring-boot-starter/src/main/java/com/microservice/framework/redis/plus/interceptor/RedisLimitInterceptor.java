...
import com.microservice.framework.redis.plus.anontation.RedisLimit;
import com.microservice.framework.redis.plus.exception.RedisLimitException;
import com.microservice.framework.redis.plus.utils.RedisAopUtils;
...
public record RedisLimitInterceptor(RedissonClient redissonClient) {
     ...
     */
    @Pointcut("@annotation(com.microservice.framework.redis.plus.anontation.RedisLimit)")
