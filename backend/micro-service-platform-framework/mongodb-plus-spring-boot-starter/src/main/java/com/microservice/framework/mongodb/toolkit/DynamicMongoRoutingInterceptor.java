package com.microservice.framework.mongodb.toolkit;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.microservice.framework.commons.exception.CheckedException;
import com.microservice.framework.mongodb.annotation.DynamicMongo;
...
public class DynamicMongoRoutingInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(com.microservice.framework.mongodb.annotation.DynamicMongo)")
