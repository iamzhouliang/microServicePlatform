...
package com.microservice.framework.boot.log.feign;
...
import static com.microservice.framework.boot.log.feign.AccessLogFeign.FEIGN_CLIENT_NAME;
...
public interface AccessLogFeign {
    ...
    String FEIGN_CLIENT_NAME = "micro-service-platform-iam";
