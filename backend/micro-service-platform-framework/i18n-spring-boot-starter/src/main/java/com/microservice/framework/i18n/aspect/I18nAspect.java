...
package com.microservice.framework.i18n.aspect;

import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.microservice.framework.commons.i18n.Language;
import com.microservice.framework.i18n.annotation.I18nField;
import com.microservice.framework.i18n.core.I18nMessageResource;
 ...
 * 国际化字段自动翻译切面
 * <p>
 * 拦截标记了 {@link com.microservice.framework.i18n.annotation.I18nMethod} 注解的方法，
...
public class I18nAspect {
     ...
     * execution(public * com.microservice.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     * annotation(com.microservice.framework.commons.annotation.log.AccessLog) 解释：
     * 标记了@AccessLog 注解的方法
     */
    @Pointcut("execution(public * com.microservice..*.*(..)) && @annotation(com.microservice.framework.i18n.annotation.I18nMethod)")
