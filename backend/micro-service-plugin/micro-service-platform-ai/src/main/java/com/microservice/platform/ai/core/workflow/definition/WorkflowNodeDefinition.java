...
public class WorkflowNodeDefinition {
    ...
    private final List<WorkflowNodePortDefinition> inputs;
    private final List<WorkflowNodePortDefinition> outputs;
    private final WorkflowNodeConfigSchema configSchema;
