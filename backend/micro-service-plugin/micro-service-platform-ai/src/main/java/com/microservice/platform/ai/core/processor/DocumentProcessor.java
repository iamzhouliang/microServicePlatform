...
public class DocumentProcessor {
    ...
    private DocumentParser getParserByContentType(String contentType) {
        ...
        } else if (normalizedContentType.contains("word") || normalizedContentType.contains("docx")
                || normalizedContentType.contains("excel") || normalizedContentType.contains("xlsx")
                || normalizedContentType.contains("powerpoint") || normalizedContentType.contains("pptx")) {
            return new ApacheTikaDocumentParser();
        } else if (normalizedContentType.contains("html")) {
            return new ApacheTikaDocumentParser();
        } else {
            // 默认使用文本解析器
