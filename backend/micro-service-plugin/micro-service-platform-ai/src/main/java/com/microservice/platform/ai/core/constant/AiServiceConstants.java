...
package com.microservice.platform.ai.core.constant;
...
public final class AiServiceConstants {
    ...
    /**
     * 日志内容预览截断长度（较短，用于问题/消息等）
     */
    public static final int SHORT_LOG_TRUNCATE_LENGTH = 50;
     ...
     * 智能体节点响应超时时间（秒）
     */
    public static final int AGENT_RESPONSE_TIMEOUT_SECONDS = 60;
     ...
     * 统计默认时区（周期起止计算）
     */
    public static final String DEFAULT_STATISTICS_ZONE = "Asia/Shanghai";
