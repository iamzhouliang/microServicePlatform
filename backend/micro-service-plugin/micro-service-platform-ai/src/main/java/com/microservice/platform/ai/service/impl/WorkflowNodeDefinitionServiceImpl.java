 ...
 */
@Service
public class WorkflowNodeDefinitionServiceImpl implements WorkflowNodeDefinitionService {

    @Override
    public List<WorkflowNodeDefinitionResp> listNodeDefinitions() {
        return WorkflowNodeDefinitionCatalog.all().stream()
                .map(WorkflowNodeDefinitionResp::of)
                .toList();
    }
}
