...
/**
 * <p>后续可优化成元组格式解析，JSON 格式消耗的 Token 较多。</p>
 *
 * @author xJh
 * @since 2025/12/12
 */
public class GraphRagTransformerFactory {
    ...
    private static final String GRAPH_RAG_JSON_EXAMPLES =
            """
                    Example 1:
                    Text:
                    OpenAI announced on March 14, 2023 that GPT-4 has been released. CEO Sam Altman stated at the \
                    press conference in San Francisco that this is a major milestone for artificial intelligence. \
                    Microsoft, as a strategic partner, has integrated GPT-4 into its Bing search engine and Office suite.
                    Output:
                    [
                        {
                            "head": "SAM ALTMAN",
