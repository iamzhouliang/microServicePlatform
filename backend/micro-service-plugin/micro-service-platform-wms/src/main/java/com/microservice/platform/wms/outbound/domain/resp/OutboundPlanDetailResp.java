package com.microservice.platform.wms.outbound.domain.resp;

import com.microservice.platform.wms.inbound.domain.enums.DeliveryMode;
import com.microservice.platform.wms.outbound.domain.enums.OutboundStatus;
import com.microservice.platform.wms.outbound.domain.enums.OutboundType;
 ...
 */
@Data
@Schema(name = "OutboundPlanDetailResp", description = "出库单详情查询响应数据")
public class OutboundPlanDetailResp {
