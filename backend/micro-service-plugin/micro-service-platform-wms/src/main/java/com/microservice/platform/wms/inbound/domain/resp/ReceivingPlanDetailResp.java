package com.microservice.platform.wms.inbound.domain.resp;

import com.microservice.platform.wms.inbound.domain.enums.ArrivalStatus;
import com.microservice.platform.wms.inbound.domain.enums.ReceivingPlanType;
import com.microservice.platform.wms.inbound.domain.enums.ReceivingStatus;
 ...
 */
@Data
@Schema(name = "ReceivingPlanDetailResp", description = "收获计划详情")
public class ReceivingPlanDetailResp {
