 ...
 */
@Data
@Schema(name = "UserProfileUpdateReq", description = "当前用户基本资料修改请求")
public class UserProfileUpdateReq {

    @Schema(description = "昵称")
    @NotBlank(message = "昵称不能为空")
    @Length(max = 50, message = "昵称长度不能超过{max}")
    private String nickname;

    @Schema(description = "邮箱")
    @NotBlank(message = "邮箱不能为空")
    @Length(max = 50, message = "邮箱长度不能超过{max}")
    ...
    @Length(max = 255, message = "个人简介长度不能超过{max}")
