...
import com.microservice.platform.iam.auth.service.ThirdAuthTemplate;
...
public class ThirdAuthController {
    ...
    public AuthUser callback(HttpServletResponse response, @PathVariable String type, AuthCallback callback) {
        ...
        response.sendRedirect("https://localhost?accountId=" + user.getUuid() + "&platform=" + type + "&tenantCode=0000");
        return user;
    }
}
