...
package com.microservice.platform.iam.auth.service.impl;

import com.microservice.platform.iam.auth.configuration.ThirdAuthProperties;
import com.microservice.platform.iam.auth.domain.dto.resp.ThirdAuthResp;
import com.microservice.platform.iam.auth.service.ThirdAuthService;
...
public class ThirdAuthGiteeServiceImpl implements ThirdAuthService {
     ...
     * 忽略 star 检测的用户
     */
    private static final List<String> IGNORE_ACCOUNT = List.of("-levin-1");
    private static final String STAR_PROJECT_NAME = "micro-service-platform";
