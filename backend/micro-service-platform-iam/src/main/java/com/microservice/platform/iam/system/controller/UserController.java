...
import com.microservice.framework.commons.entity.Entity;
import com.microservice.framework.db.mybatisplus.datascope.service.DataScopeService;
import com.microservice.framework.excel.annotation.ResponseExcel;
...
public class UserController {
    ...
    @PutMapping("/profile")
    @AccessLog(module = "个人中心", description = "修改基本资料")
    @Operation(summary = "修改当前用户基本资料")
    public void updateProfile(@Validated @RequestBody UserProfileUpdateReq req) {
        this.userService.updateProfile(req);
    }

    @PutMapping("/password")
    @AccessLog(module = "个人中心", description = "修改密码", request = false, response = false)
    @Operation(summary = "修改当前用户密码")
    public void updatePassword(@Validated @RequestBody UserPasswordUpdateReq req) {
