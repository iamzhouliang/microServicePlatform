...
import com.microservice.framework.commons.entity.enums.UserType;
...
import com.microservice.framework.db.dynamic.DynamicDataSourceHandler;
import com.microservice.framework.db.dynamic.core.DynamicDataSourceEvent;
import com.microservice.framework.db.dynamic.core.EventAction;
...
import com.microservice.framework.db.utils.TenantHelper;
import com.microservice.framework.security.utils.PasswordEncoderHelper;
import com.microservice.platform.iam.base.domain.entity.AreaEntity;
import com.microservice.platform.iam.base.domain.entity.SysDict;
import com.microservice.platform.iam.base.repository.AreaMapper;
import com.microservice.platform.iam.base.repository.SysDictMapper;
import com.microservice.platform.iam.system.domain.entity.*;
import com.microservice.platform.iam.system.repository.*;
import com.microservice.platform.iam.system.service.UserRoleService;
import com.microservice.platform.iam.tenant.domain.dto.req.TenantConfigReq;
import com.microservice.platform.iam.tenant.domain.dto.req.TenantDbBindingSaveReq;
import com.microservice.platform.iam.tenant.domain.dto.req.TenantSaveReq;
import com.microservice.platform.iam.tenant.domain.dto.req.TenantSettingReq;
import com.microservice.platform.iam.tenant.domain.dto.resp.DbInstancePageResp;
import com.microservice.platform.iam.tenant.domain.dto.resp.TenantDbBindingResp;
import com.microservice.platform.iam.tenant.domain.dto.resp.TenantSettingResp;
import com.microservice.platform.iam.tenant.domain.entity.Tenant;
import com.microservice.platform.iam.tenant.domain.entity.TenantDbBinding;
import com.microservice.platform.iam.tenant.repository.DbInstanceMapper;
import com.microservice.platform.iam.tenant.repository.TenantDbBindingMapper;
import com.microservice.platform.iam.tenant.repository.TenantDictMapper;
import com.microservice.platform.iam.tenant.repository.TenantMapper;
import com.microservice.platform.iam.tenant.service.DbInstanceService;
import com.microservice.platform.iam.tenant.service.TenantService;
...
public class TenantServiceImpl extends SuperServiceImpl<TenantMapper, Tenant> implements TenantService {
    ...
    private void clearTenantData(Tenant tenant, List<User> users) {
        ...
        if (CollUtil.isNotEmpty(userIdList)) {
            // 等于0全表会删。
            this.userRoleService.deleteByUsers(userIdList);
        }
    ...
    private void initDatasourceTypeTenant(Tenant tenant) {
        final DynamicDataSourceHandler dynamicDataSourceHandler = SpringUtil.getBean(DynamicDataSourceHandler.class);
    ...
    private void initializeTenantData(Tenant tenant, Role role) {
        ...
        this.userRoleService.replaceRolesForUser(user.getId(), List.of(role.getId()), null);
    }
