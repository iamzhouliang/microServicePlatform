...
import com.microservice.framework.boot.log.event.AccessLogListener;
import com.microservice.framework.log.diff.core.annotation.EnableDiffLog;
import com.microservice.framework.security.configuration.server.annotation.EnableOAuth2Server;
import com.microservice.framework.websocket.redis.EnableRedisWebSocket;
import com.microservice.platform.iam.base.service.OptLogService;
...
@MapperScan(value = "com.microservice.**.repository", annotationClass = Repository.class)
