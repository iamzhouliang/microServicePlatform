...
import com.microservice.platform.gateway.rest.domain.RouteRule;
...
import static com.microservice.platform.gateway.configuration.rule.GatewayRule.Constants.GATEWAY_RULE_ROUTE;
